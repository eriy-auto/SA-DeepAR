...
class GaussianLayer(Layer):
    ...
    def build(self, intput_shape):
        ...
        print('GaussianLayer_input_shape:', intput_shape)
        n_weight_rows = intput_shape[2]  # 原本为2
        ...
        super(GaussianLayer, self).build(intput_shape)
    ...
    def compute_output_shape(self, input_shape):
        ...
        """
        print('compute_output_shape', [(input_shape[0], self.output_dim), (input_shape[0], self.output_dim)])
