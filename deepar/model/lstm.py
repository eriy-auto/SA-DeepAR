...
from DEEPAR_code.deepar_tensorflow_master.deepar.model.loss import gaussian_likelihood
from DEEPAR_code.deepar_tensorflow_master.deepar.model import NNModel
from DEEPAR_code.deepar_tensorflow_master.deepar.model.layers import GaussianLayer
...
class DeepAR(NNModel):
    def __init__(self, ts_obj, steps_per_epoch=50, epochs=100, loss=gaussian_likelihood, optimizer="adam",
